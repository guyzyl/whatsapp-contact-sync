...
<template>
  <div id="home" class="hero min-h-screen bg-base-200">
    <div class="hero-content text-center">
      <div class="max-w-md">
        <h1 class="text-5xl font-bold">WhaSync</h1>
        <p class="py-6">
          ...
          <br />
          Don't believe me? You can checkout the code yourself over on <a href="
          https://github.com/guyzyl/whatsapp-contact-sync">GitHub</a>.
        </p>
