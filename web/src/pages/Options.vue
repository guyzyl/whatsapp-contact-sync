...
interface Option {
  ...
  target: string;
  value: boolean;
  disabled?: (options: Option[]) => boolean;
    ...
    options: [
      {
        ...
        target: "manual_sync",
        value: false,
        onChange: (options: Option[]) => (event: Event) => {
          const checkbox = event.target as HTMLInputElement;
          if (checkbox.checked) {
            options.filter((o) => o.target !== "manual_sync").forEach((o) => (o.value = false));
          }
        },
      },
      {
        ...
        value: false,
        disabled: (options: Option[]) => options.filter((o) => o.target === "manual_sync")[0].value,
      },
    ],
  }),
  mounted() {},
        ...
        <div class="form-control pt-6 flex flex-col">
          ...
          >
            ...
            <input
              ...
              :disabled="option.disabled?.(options)"
